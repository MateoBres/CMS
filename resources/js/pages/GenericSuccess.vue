<template>
  <div class="d-flex h-100">
    <div class="m-auto d-flex flex-column">
      ...
      <span class="font-weight-bold text-center" style="font-size: 2.5rem;">Operazione andata a buon fine</span>
      <span class="text-center" style="font-size: 1.5rem;">{{ message }}</span>
      <router-link

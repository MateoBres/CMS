...
<div class="col col-12">
    ...
    <shop-header
     ...
     <div id="white-section" class="bg-white rounded">
            <div class="row">
                <div id="menu" class="row w-100 text-uppercase" style="margin-top: 25px; margin-left: 0; height: 50px;">
                    <p ref="negozio-tab" class="col-6 text-center p-0 font-weight-bold">
                        negozio {{ cover }}
                    </p>
                    <p ref="prodotti-tab" class="col-6 text-center p-0">
                        prodotti
                    </p>
                </div>

                <div class="row">
                    <div class="col-11 mx-auto bg-dark" style="height: 1px; opacity: 60%;"></div>
                </div>
        ...
        async getRetailer() {
            await axios
                ...
                .then(response => {
                    ...
                    //this.logo = `/storage/${this.this.retailer_vat}/img/profile/logo.jpg`;
                    //this.cover = `/storage/${this.this.retailer_vat}/img/profile/cover.jpg`;
                    this.getArticleData();
                })
                .catch(errors => {});
        },

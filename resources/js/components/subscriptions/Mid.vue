<template>
  <div class="border border-secondary rounded h-100">
      <h2 class="font-weight-bold text-center py-4 border-bottom border-2 border-secondary bg-secondary text-white h3">Standard</h2>
      <h2 class="font-weight-bold text-center py-4 h4">€ 16,90 / mese<br /><small>pagamento annuale</small></h2>
